...
sci_b_i2c_instance_ctrl_t g_sci9_ctrl;
const sci_b_i2c_extended_cfg_t g_sci9_cfg_extend =
{
...
const i2c_master_cfg_t g_sci9_cfg =
{
    .channel             = 9,
...
#undef RA_NOT_DEFINED
    ...
    .p_context           = NULL,
#if defined(VECTOR_NUMBER_SCI9_RXI) && SCI_B_I2C_CFG_DTC_ENABLE
    ...
    .p_extend            = &g_sci9_cfg_extend,
};
/* Instance structure to use this module. */
const i2c_master_instance_t g_sci9 =
{
    .p_ctrl        = &g_sci9_ctrl,
    .p_cfg         = &g_sci9_cfg,
